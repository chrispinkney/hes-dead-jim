...
def file_check_ignored(file, ignored_urls_list):
    try:
        with open(file, 'r') as f:  # Open and parse the HTML file
            ...
            print(f"Removing links from from: {file}, please wait. This might take a while depending on the file size.")
        ...
        print(f"The test file specified ({file}) could not be opened. Please check if your path is correct or if the file exists.")
        quit()